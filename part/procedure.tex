...
\item Producing basic paper beams
	\begin{enumerate}
	\item Prepare A4 papers with the size of 21.0cm $\times$ 29.7cm, weighing 80 grams per square meter.
	\item Use paper cutter to cut papers into 9.5cm $\times$ 29.7cm.
	\item Prepare a wood mould with the size of 0.5cm $\times$ 1.0cm $\times$ 30.0cm.
