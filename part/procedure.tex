...
\item Producing basic paper beams
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedureJuanzhi/p4}
	\end{center}
	\end{figure}
...
\item Producing bridge’s main long beams
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedureBridge/forehead}
	\end{center}
	\end{figure}
...
\item Assembling one side of the bridge
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedureBridge/p1}
	\end{center}
	\end{figure}
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedureBridge/p3}
	\end{center}
	\end{figure}
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedureBridge/p4}
	\end{center}
	\end{figure}
...
\item Connecting two sides of the bridge to form the structure
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedureBridge/p6}
	\end{center}
	\end{figure}
	\item Use electric hair drier to dry the connection part. 
	\end{enumerate}
...
\item Assembling Motor, Servo and Wheels
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedure/p4}
	\end{center}
 	\caption{Step 4.3 \label{fig:step43}}
	\end{figure}
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedure/p5}
	\end{center}
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedure/p6}
	\end{center}
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[height=8cm]{figure/procedure/p7}
	\end{center}
