...
\subsection{Bridge}
\smallskip
\textbf{Overview of the bridge’s procedure}
...
\item Producing paper stripes
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figure/procedureBridge/p8}
	\end{figure}
...
\item Assembling one side of the bridge
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[width=12cm]{figure/procedureBridge/p3}
	\end{center}
	\end{figure}
	...
	\begin{figure}[H]
	\begin{center}
	\includegraphics[width=12cm]{figure/procedureBridge/p4}
	\end{center}
	\end{figure}
...
\item Connecting two sides of the bridge to form the structure
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=8cm]{figure/procedureBridge/p7}
	\end{figure}
...
\item Design circuit diagram
	The design of circuit diagram is shown as follow
	\begin{figure}[H]
	\centering
	\includegraphics[width=10cm]{figure/procedure/p9}
 	\caption{The Design of Circuit Diagram \label{fig:designOfCircuit}}
	\end{figure}
\item Design wheels
	\begin{enumerate}
...
\item Assembling Motor, Servo and Wheels
	...
	\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[height=4cm]{figure/procedure/p5}
	...
	\item Stick a voltage transformer at the back of the base using 3M tape. \\ \textbf{Caution:} Use multiple layers of tape to make sure the transformer strongly sticked to the board.
	\item Stick a battery on the base using 3M tape. 
	\begin{figure}[H]
	\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[height=5cm]{figure/procedure/p6}
 	\caption{Assembling the voltage transformer.\label{fig:assMotor}}
	\end{minipage}
	\begin{minipage}{0.48\textwidth}
	\centering
	\includegraphics[height=5cm]{figure/procedure/p7}
 	\caption{Assembling the motor driver \label{fig:ardUnoBoard}}
	\end{minipage}
	\end{figure}
	\item Assembling the motor driver with two motor using tin solder. \\ \textbf{Caution:} tin solder is very dangerous. Do not let your skin contact with tin when it is still hot.
